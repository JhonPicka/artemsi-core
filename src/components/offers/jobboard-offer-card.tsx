...
export function JobboardOfferCard({ offer, initialInterested, isPro = true }: JobboardOfferCardProps) {
  ...
  const isCardInteractive = isExclusive || opensExternally;

  return (
    <>
      <article
        className={`offer-card offer-card--jobboard${interested ? " offer-card--interested" : ""}${isCardInteractive ? " offer-card--clickable" : ""}${isExclusive ? " offer-card--exclusive" : ""}`}
      ...
      >
        ...
        <div
          className={`offer-card-actions offer-card-actions--compact${isExclusive ? " offer-card-actions--exclusive" : ""}`}
        >
          {isExclusive ? (
            <>
              <button
